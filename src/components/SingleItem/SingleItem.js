...
<ChakraProvider>
    <div className={styles.singleItem}>
      ...
      <div className={styles.singleItem__details}>
        ...
        <button className={`${styles.buttons__btn} ${styles.details__addBtn}`} onClick={()=>navigate('/')}>Back</button>
        <button className={`${styles.buttons__btn} ${styles.details__addBtn}`} onClick={() => 
            handleAddToCart(currentItem.id)}>Add To Cart</button>
